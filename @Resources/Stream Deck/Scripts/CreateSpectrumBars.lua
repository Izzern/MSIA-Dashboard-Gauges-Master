function Initialize()
    ...
    -- Define file path
    spectrumFP = SKIN:MakePathAbsolute(SKIN:ReplaceVariables("#@#Visualizer\\spectrum2.inc"))
...
function GenerateSpectrum(bands)
    ...
    file:write("UnitWidth=(#BarWidth# * #Scale#)\n")
    file:write("UnitHeight=((#BarHeight# + #BarSpacingY#) * #Scale#)\n")
    file:write("UnitRounding=((#BarWidth# / 2) * #Scale#)\n")
    file:write("UnitStartX=((#BarWidth# + #BarSpacingX#) * #Scale#)\n")
    file:write("UnitStartY=((#BarHeight# + #BarSpacingY# + #Jump#) * #Scale#)\n\n")
    ...
    file:write("Shape=Rectangle 0, ((#BarHeight# * #Scale#) - ([CalcBand1] * #Jump#)), #UnitWidth#, (Neg([CalcBand1] * #Gain#)), #UnitRounding# | Extend SpectrumModifiers\n\n")
    ...
    for i = 1, bands do
        ...
        local y = "((#BarHeight# * #Scale#) - ([CalcBand" .. i .. "] * #Jump#))"
